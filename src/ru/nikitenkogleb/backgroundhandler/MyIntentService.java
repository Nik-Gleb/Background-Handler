...
public class MyIntentService extends IntentService {
    ...
    private static final String ACTION_FOO = "ru.nikitenkogleb.backgroundhandler.action.FOO";
    private static final String ACTION_BAZ = "ru.nikitenkogleb.backgroundhandler.action.BAZ";

    // TODO: Rename parameters
    private static final String EXTRA_PARAM1 = "ru.nikitenkogleb.backgroundhandler.extra.PARAM1";
    private static final String EXTRA_PARAM2 = "ru.nikitenkogleb.backgroundhandler.extra.PARAM2";
    ...
    private void handleActionFoo(String param1, String param2) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            sendBroadcast(new Intent("Service Action"));
        }
        sendBroadcast(new Intent("Service Action"));
    }
